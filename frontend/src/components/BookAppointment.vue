...
<template>
  ...
  export default {
    ...
    methods: {
      submitAppointment() {
        // Here you would send the data to your backend or display a success message
        alert(`Appointment booked for ${this.name}`);
        this.$router.push('/'); // Redirect to homepage or a confirmation page
      },
    },
  };
  </script>
